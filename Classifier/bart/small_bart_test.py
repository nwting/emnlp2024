...
from Classifier.utils import read_json, test_for_smallBART


def small_bart_test(args,logger,tepath,tagpath):
    device = args.device
    ...
    test_set = SmallBartDataset(args, True,test_data, tokenizer, classes_map)
